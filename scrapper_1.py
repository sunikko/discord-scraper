...
for item in items:
    ...
    stock = {
        'title': stock_title,
        'price': stock_price,
        'img_url': "https://www.amazon.co.uk/" + img_url,
        'url': "https://www.amazon.co.uk/" + stock_url
    }
    print(stock)

            
    # items = item.find_all('div', data_cy='title-recipe') > a>h2>span
# soup.find('div', class_='jobsearch-JobComponent-description').get_text("strip":"True",)
